...
DATASET_ROOT = Path("/kaggle/input/datasets/renyh7zzzz/daisee-frames12-labels-20260423")

RUN_ENV = "kaggle"  # fixed for Kaggle single-file usage
LOCAL_OUT_DIR = Path("/kaggle/working/results/focus_multitask_gpu_e30_local_fallback")
...
# Loss weights for the four tasks (Engagement-prioritized)
W_BOREDOM = 0.5
W_ENGAGEMENT = 1.5
W_CONFUSION = 0.5
W_FRUSTRATION = 0.5
...
def main() -> None:
    ...
    if DEVICE != "cuda":
        ...
        # Throughput-oriented defaults for Kaggle GPU.
